...
namespace Photo_Tagger_V2_0
{
    class ImageTagger
    {
        ...
        public ImageTagger(string position)
        {
            this.position = position;
        }

        public Image TagImage(FileInfo imageInfo, FileInfo logoInfo)
        {
            ...
            double scaleFactor = getLogoScale(logo, image);
        ...
        private Image applyEXIFData(Image inputImage, Image outputImage)
        {
        ...
        private double getLogoScale(Image logo, Image image)
        {
        ...
        private Image resizeImage(Image image, double factor)
        {
